...
| [!UICONTROL Viewability IAS] | Définit un pourcentage minimal de visibilité requis, à l’aide de données historiques provenant de [!DNL IAS]. Vous proposerez une impression lorsque le seuil spécifié sera atteint. | Ce filtre fonctionne mieux car plus de données sont extraites par le biais d’une intégration [!DNL IAS] de niveau campagne.<br><br>Lorsque la campagne est configurée pour utiliser  [!DNL IAS] des données, la bonne pratique consiste à utiliser ce filtre avec l’objectif d’optimisation du package &quot;[!UICONTROL Lowest vCPM (IAS)]&quot;. Si l’intégration n’est pas activée, utilisez ce filtre avec l’objectif d’optimisation &quot;[!UICONTROL Lowest CPM]&quot;. |
| [!UICONTROL Viewability Moat] | Définit un pourcentage minimal de visibilité requis, à l’aide de données historiques provenant de [!DNL Moat]. Vous proposerez une impression lorsque le seuil spécifié sera atteint. | Ce filtre fonctionne mieux car plus de données sont extraites par le biais d’une intégration [!DNL Moat] de niveau campagne.<br><br>Lorsque la campagne est configurée pour utiliser  [!DNL Moat] des données, la bonne pratique consiste à utiliser l’objectif d’optimisation du package &quot;[!UICONTROL Lowest vCPM (Moat)]&quot;. Si l’intégration n’est pas activée, utilisez ce filtre avec l’objectif d’optimisation &quot;[!UICONTROL Lowest CPM]&quot;. |
