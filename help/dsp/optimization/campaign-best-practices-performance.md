...
* **[!UICONTROL Device Targeting]**:
   ...
   * Ne pas cibler [!UICONTROL Firefox] et [!UICONTROL Safari] en raison des limitations de ciblage et de mesure. Contactez votre [!DNL Adobe] gestionnaire de compte pour en savoir plus [!DNL Adobe] prise en charge de [!DNL Safari ITP].
