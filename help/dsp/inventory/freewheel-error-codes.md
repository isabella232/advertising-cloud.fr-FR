...
|--- |--- |--- |--- |
| 401 | Non autorisé | Informations d’accès incorrectes, manquantes ou non valides. | Contactez votre [!DNL Adobe] gestionnaire de compte. |
| 403 | Interdit | Le serveur a compris la demande mais refuse de l’autoriser. | Contactez votre [!DNL Adobe] gestionnaire de compte. |
| 404 | Introuvable | La ressource que vous avez demandée n’est pas disponible. Si l’ID créatif est introuvable dans l’opération du PUT, un 404 est renvoyé. | Contactez votre [!DNL Adobe] gestionnaire de compte. |
...
| 500 | Erreur interne du serveur | Erreur du système API. | Contactez votre [!DNL Adobe] gestionnaire de compte. |
