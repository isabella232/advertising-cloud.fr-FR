...
1. Identifiez l’ID d’Experience Cloud de votre entreprise et assurez-vous qu’il est lié à vos comptes Advertising Cloud.
...
* `"namespace": **imsOrgID**`
* `"value":` &lt;*la valeur d’identifiant Experience Cloud de votre entreprise ;*>
